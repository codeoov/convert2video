...
<!-- sync:cursor-only -->
1. 프롬프트 `═══ HARNESS RULE CONTEXT` 또는 Read `.cursor/harness/cache/latest-plan_evaluator.md`
2. Type C/M 검증 시 manifest `type_extra`에 있는 security·structure 룰을 Contract 대조
<!-- /sync:cursor-only -->
<!-- sync:claude-only
