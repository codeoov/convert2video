---
name: "source-command-pre-work"
description: "Migrated source command `pre-work`"
---

# source-command-pre-work

Use this skill when the user asks to run the migrated source command `pre-work`.
...
`AGENTS.md`(단일 소스)에서 이번 작업에 해당하는 섹션을 연다:

- 핵심 → `AGENTS.md` § Core Conventions
- 폴더·역할 → `AGENTS.md` § Folder Structure
- 제품 플로우 → `AGENTS.md` § Product Scope
- 단일 소스·금지 → `AGENTS.md` § Anti-Repeat / Single-Source Rules
- 용어 → `AGENTS.md` § Terminology Glossary
